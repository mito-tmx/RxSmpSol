...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("59434f1f-4e3e-454a-afe4-f9178b4f8ad9", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.トップページ.ログアウト' at Center.", repo.ApplicationUnderTest.トップページ.ログアウトInfo, new RecordItemIndex(0));
            repo.ApplicationUnderTest.トップページ.ログアウト.Click();
